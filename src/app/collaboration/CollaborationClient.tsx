...
import { ShieldCheck, GitBranch, Rocket, Users, Terminal, CheckCircle, Clock, Settings, UploadCloud, Share2, Circle } from 'lucide-react';
                    ...
                    <div className="lg:col-span-1 flex flex-col gap-8">
                         ...
                         <Card className="bg-card/80 backdrop-blur-md shadow-2xl border-border/50">
                            <CardHeader className="flex flex-row items-center justify-between">
                                ...
                                <Button size="sm"><UploadCloud className="mr-2 h-4 w-4" /> Deploy</Button>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <DeploymentStep icon={Terminal} title="Build" status="Completed" description="Build succeeded in 24s." />
                                <DeploymentStep icon={Settings} title="Unit Tests" status="Completed" description="128/128 tests passed." />
                                <DeploymentStep icon={UploadCloud} title="Deploy to Robot" status="In Progress" description="Uploading `firmware-v2.1.3.bin`..." isLast={true} />
                            </CardContent>
                        </Card>
